...
public class FirstFitComp extends Memory{
    ...
    public Pointer alloc(int size) {
        ...
        if (freeList.size() == 1){
            ...
            // Om inget returneras har man kommit till slutet och ska lägga längst bak.
            addressMap.put(freeList.getLast()[0], freeList.getLast()[0] + size);
            p = new Pointer(freeList.getLast()[0], this);
            freeList.getLast()[0] += size;
            return p;
        }
